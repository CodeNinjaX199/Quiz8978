...
const programmingLanguageQuizz: Record<string, Question[]> = {
  HTML: [
    {
  ...
  CSS: [
    ...
    {
      question:
        "Which CSS property is used to change the background color of an elemant?",
    ...
    {
      question:
        "Which CSS property is used to change the font style of an elemen?",
    ...
    {
      question:
        "Which CSS property is used to change the right margin of an element?",
      options: ["margin-right", "right-margin", "margin", "padding-margin"],
      correctAnswer: "margin-right",
    },
    {
      question:
        "Which CSS property is used to change the top margin of an element?",
      options: ["margin-top", "top-margin", "margin", "padding-top"],
      correctAnswer: "margin-top",
    },
    {
      question:
        "Which CSS prperty is used to change the text alignment of an element?",
  ...
  TypeScript: [
    ...
    {
      question:
        "Which feature of TypeScript hepls in catching errors during development?",
      options: [
        "Type checking",
        "Syntax highlighting",
        "Code folding",
  ...
  Python: [
    ...
    {
      question:
        "Which feature of Python helps in catching errors during development?",
      options: [
        "Exception handling",
        "Syntax highlighting",
        "Code folding",
...
async function startProgrammingLanguageQuiz(languae: string) {
